...
- `03-photographic-keepsake.png` — physical print direction.

Production favicon files derived from the selected booth-portal concept live in
`../favicon/`. The Next.js browser favicon is installed at
`../../../src/app/favicon.ico`.
