...
const surfaces = [
  ...
  { id:'guest-start', name:'Guest Start', audience:'guest', states:['ready','exit-hold-idle','exit-holding','exit-hold-cancelled','exit-confirmation-open'], risk:'long-event-name-and-exit-hold', heading:'Let’s take some photos', order:['FotoHAVN header','Event name','heading','instructions','Touch to start','Exit event'] },
  { id:'guest-start-unavailable', name:'Guest Start unavailable', audience:'guest', states:['camera-retry','camera-exit-only','storage-retry','storage-exit-only','retrying','retry-failed'], risk:'longest-recovery-copy', heading:'Camera needs attention', order:['FotoHAVN header','Event name','heading','reason','Retry or Exit event'] },
